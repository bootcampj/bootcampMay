package com.bootcamp.jms.receive;
...
/**
* This class shows how to establish a connection to
...
public class QueueReceive implements MessageListener
{
 ...
 public final static String JMS_FACTORY="bootcamp";

 // Defines the queue.
 public final static String QUEUE="bootcampQ";
